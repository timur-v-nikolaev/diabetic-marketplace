...
export default function VKCreateListing() {
  ...
  if (!isAuthenticated) {
    return (
      <>
        <Head>
          <title>Создать объявление — VK Mini App</title>
        </Head>
        <div className="min-h-screen bg-avito-bg pb-20">
          ...
          <div className="p-4 text-center">
            ...
            <button
              onClick={() => router.push('/vk/cabinet')}
              className="avito-btn avito-btn-primary"
            >
              Войти
            </button>
          </div>
          <AvitoBottomNav activeTab="create" prefix="/vk" />
        </div>
      </>
    );
  }
