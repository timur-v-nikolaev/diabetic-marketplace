  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-avito-bg pb-20">
        ...
        <AvitoBottomNav activeTab="profile" prefix="/tg" />
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-avito-bg pb-20">
        ...
        <main className="p-4 space-y-4">
          ...
          <div className="bg-white rounded-avito-lg divide-y divide-avito-border">
            <Link href="/tg/listings/create" className="flex items-center gap-3 p-4">
            ...
            <Link href="/tg/favorites" className="flex items-center gap-3 p-4">
            ...
            <Link href="/tg/messages" className="flex items-center gap-3 p-4">
              <span className="text-xl">💬</span>
